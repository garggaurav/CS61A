...
class Place:
    ...
    def remove_insect(self, insect):
        ...
        if not insect.is_ant():
            ...
            if type(insect) is QueenAnt and not insect.is_imposter:
                return
            elif type(insect) is BodyguardAnt and type(insect.ant) is QueenAnt and not insect.ant.is_imposter:
                return
...
class Bee(Insect):
    ...
    name = 'Bee'
    def __init__(self, armor, watersafe=True, place=None):
        """Create an Insect with an armor amount and a starting Place."""
        Insect.__init__(self, armor, watersafe)
...
class Ant(Insect):
    ...
    def __init__(self, armor=1, watersafe=False):
    ...
    def can_contain(self, ant):
        return self.container==True and self.ant==None and ant.container==False
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        distance = 0
        while current_place.entrance is not hive:
            if current_place.bees and distance >= self.min_range and distance <= self.max_range:
                break
...
class ScubaThrower(ThrowerAnt):
    ...
    def __init__(self, armor=1):    
        ThrowerAnt.__init__(self, armor, ScubaThrower.watersafe)
        ...
        if self.is_imposter:
            ...
            while current_place is not None:
                if current_place.ant:
                    if type(current_place.ant) is not QueenAnt and not current_place.ant.damage_doubled:
                        current_place.ant.double_damage()
                current_place = current_place.entrance
