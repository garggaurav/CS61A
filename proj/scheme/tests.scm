...
;;;custom tests : sudip guha and gaurav garg
;;;<!--Custom Tests Begins-->
;q1 and q2
;q3 and q4
...
(define pie 3.1415926) ; expect pie
pie
...
(let ((x 42)
          ...
          (list x y))
;expect (42 50)
(let ((define (f x) (* x 2))) (f 3))
;expect 6 (testing function definitions in side the do let form)
;q17
...
;Note : Tests for nested function definitions not added as they are tested in the sqrt function 
;       defuned later in the program
